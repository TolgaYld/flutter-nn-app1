...
class ReadvertiseStadScreen extends StatefulWidget {
  String stadId;
  ReadvertiseStadScreen({Key? key, required this.stadId}) : super(key: key);

  static const routeName = '/readvertise_stad';
  @override
  _ReadvertiseStadScreenState createState() => _ReadvertiseStadScreenState();
}

class _ReadvertiseStadScreenState extends State<ReadvertiseStadScreen> {
  late String stadId;
    ...
    if (_shortDescriptionController.text.length < 3 ||
      ...
      if (_files.isNotEmpty) {
        ...
        if (_files.length == _imgOrVidUrls.length &&
          ...
          if (!hasException) {
            try {
              await Provider.of<Stads>(context, listen: false).addStad(
                Stad(
              ...
              Provider.of<SubsubCategorysStad>(context, listen: false)
                ...
                Provider.of<OpeningHours>(context, listen: false)
                  ...
                  if (_openingHours.isEmpty) {
                    ...
                    DateTime? end = calculatedDates.first.duration.inMinutes <
                            15
                  ...
                  SliverOverlapAbsorber(
                    ...
                    sliver: SliverSafeArea(
                      ...
                      sliver: SliverAppBar(
                        ...
                        title: const Text('Readvertise STAD',
