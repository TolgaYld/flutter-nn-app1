...
class ReadvertiseQrofferScreen extends StatefulWidget {
  String qrofferId;
  ReadvertiseQrofferScreen({Key? key, required this.qrofferId})
      : super(key: key);

  static const routeName = '/readvertise_qroffer';
  @override
  _ReadvertiseQrofferScreenState createState() =>
      _ReadvertiseQrofferScreenState();
}

class _ReadvertiseQrofferScreenState extends State<ReadvertiseQrofferScreen> {
                  ...
                  SliverOverlapAbsorber(
                    ...
                    sliver: SliverSafeArea(
                      ...
                      sliver: SliverAppBar(
                        ...
                        title: const Text('Readvertise QROFFER',
